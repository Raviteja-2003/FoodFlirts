...
const Food = require('../models/Food');  // Import your Mongoose model

router.post('/foodData', async (req, res) => {
  try {
    // Assuming you have a Mongoose model named Food
...
//         // const userId = req.user.id;
//         const data =  await database.FoodFlirts({name:"food_items"}).find({});
//         res.json({data});
//     } catch (error) {
//         console.error(error.message)
//         res.send("Server Error")
